    ...
    'payments' => [
        ...
        'gateway_configuration' => [
            ...
            'paystack' => [
                ...
                'currencySymbol'              => '',
                'paystackTestingSecretKey'         => 'YOUR_PAYSTACK_TEST_SECRET_KEY', //paystack testing secret key
                'paystackTestingPublicKey'         => 'YOUR_PAYSTACK_TEST_PUBLIC_KEY', //paystack testing public key
            ...
            'mercadopago' => [
                ...
                'currencySymbol'                => '$', //currency Symbol
                'testAccessToken'               => '',
                'liveAccessToken'               => 'YOUR_MERCADOPAGO_LIVE_ACCESS_TOKEN',
                'callbackUrl'                   => 'payment-response.php', //callback Url after payment successful
