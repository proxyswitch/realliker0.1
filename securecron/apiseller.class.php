...
class apisellerapi
{
    public $api_url = 'https://apiseller.com/api/v2'; // API URL

    public $api_key = '2acdebf510190c8e554183a39cacaf63'; // Your API key
...
//$order = $api->order(array('service' => 161, 'link' => 'http://example.com/test', 'quantity' => 100)); # Default
//var_dump ($order);
