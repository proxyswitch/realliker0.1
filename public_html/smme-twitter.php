...
$service=$commonobj->getservicedetailsbyname("twitter");
$sitecontent=$commonobj->sitecontent("twitter");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Twitter</h4>
...
<textarea name="urls" placeholder="Format: url|count per line. ex: twitter.com/smmexchange|100" class="urls form-control required" id="urls">
</textarea>
</div>
