...
<h4 class="text-center title">Vine</h4>
...
<textarea name="urls" placeholder="Format: url|count per line. ex: vine.co/smmexchange|100" class="urls form-control required" id="urls">
</textarea>
</div>
