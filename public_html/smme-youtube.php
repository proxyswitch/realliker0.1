...
$service=$commonobj->getservicedetailsbyname("youtube");
$sitecontent=$commonobj->sitecontent("youtube");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Youtube</h4>
...
<textarea name="urls" placeholder="Format: url|count per line. ex: youtube.com/watch?v=HaUh-o|100" class="urls form-control required" id="urls">
</textarea>
</div>
