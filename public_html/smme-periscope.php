...
$service=$commonobj->getservicedetailsbyname("Periscope");
$sitecontent=$commonobj->sitecontent("Periscope");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Periscope</h4>
