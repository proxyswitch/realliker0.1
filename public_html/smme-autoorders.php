...
$service=$commonobj->getautoorderservicedetailsbyname("instagram");
$sitecontent=$commonobj->sitecontent("instagram-automatic");
?>
<script src="js/userautoorders.js"></script>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Instagram Automatic Orders</h4>
<form name="serviceform" class="serviceform12" action="" method="post">
...
<label>Instagram Latest Post Link</label>
...
<input type="text" name="noofpost"  value="" id="noofpost" class="required noofpost form-control" />
</div>
</div>
...
<div class="form-group">
<label>UserName</label><input type="text" value="" class="form-control" id="suser">
</div>
