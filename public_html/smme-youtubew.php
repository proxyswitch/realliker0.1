...
$service=$commonobj->getservicedetailsbyname("YoutubeW");
$sitecontent=$commonobj->sitecontent("YoutubeW");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Youtube Watchtime</h4>
...
<textarea name="urls" placeholder="Format: url|count per line. ex: soundcloud.com/smmexchange|100" class="urls form-control required" id="urls">
</textarea>
</div>
