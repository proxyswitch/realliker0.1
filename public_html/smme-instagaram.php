...
$service=$commonobj->getservicedetailsbyname("instagram");
$sitecontent=$commonobj->sitecontent("instagram");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Instagram</h4>
...
<textarea name="urls" placeholder="Format: url|count per line. ex: instagram.com/smmexchange|100" class="urls form-control required"  id="urls">
</textarea>
</div>
<div class="form-group extdatadivc" style="display:none;">
<label>Comments (1 per line)</label>
<textarea name="ccomments" 
placeholder="THANK YOU
GOOD 
GREAT " class="ccomments form-control required"  id="ccomments">
</textarea>
</div>
...
<marquee><b><font size="3" color="red">Hello Guys Be Attention!! Instagram Followers Service Having No Refill Gurantee Keep In Mind For More Information Read Faq And Terms And Conditions Smmexchange Will Not Responsible For It!!<b></font></marquee>
</div>
</div>
