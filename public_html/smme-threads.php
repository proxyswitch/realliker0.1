...
$service=$commonobj->getservicedetailsbyname("Threads");
$sitecontent=$commonobj->sitecontent("Threads");
?>
<div class="container content">
<div class="col-lg-6">
<div class="serviceform">
<h4 class="text-center title">Threads</h4>
...
<textarea name="urls" class="urls form-control required" placeholder="Format: url|count per line. ex: threads.net/smmexchange|100"  id="urls">
</textarea>
</div>
