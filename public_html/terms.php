<html>
<head>
<title>SmmeXchange - Terms and Conditions</title>
...
<div class="header">
<div class="container">
<ul class="nav pull-right normalmenu"><li class="pull-left"><a href="index">Login</a></li><li class="pull-left"><a href="register">Register</a></li><li class="pull-left"><a href="aboutus">About Us</a></li><li class="pull-left"><a href="privacypolicy">Privacy Policy</a></li><li class="pull-left"><a href="#" class="active">Terms Of Service</a></li><li class="pull-left"><a href="contact-us">Contact Us</a></li></ul>
</div>
</div>
...
<div class="footer"><div class="container"><div class="text-center">&copy; 2016 smmexchange.com</div></div></div>
</div>
</div>
</body>
</html>