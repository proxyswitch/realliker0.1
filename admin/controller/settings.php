<?php
  ...
  $menuList = ["General Settings"=>"general","Providers"=>"providers","Payments"=>"payment-methods",  "Modules"=>"modules","Bonuses"=>"payment-bonuses","Currency"=>"currency","Notification settings"=>"alert","Contact Abhijeet"=>"contactus"];
