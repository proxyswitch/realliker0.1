  ...
  <div class="panel panel-default">
    <div class="panel-body">
      <form action="" method="post" enctype="multipart/form-data">
          ...
          <label class="control-label">If You Chnage The Theme || You Have To Change there Theme Colour </label>
...
<form action="" method="post" enctype="multipart/form-data">
<div class="form-group">
    <?php  if( $settings["site_theme"] == "0C8t2cUp9wzh2tWfUWiDhRzHlRjKBeyWA7rG" ):  ?>
          <label class="control-label">Theme Colour For ABHIJEETFIX DREAM</label>
...
<option value="Blue" >Blue</option>
                     <option value="Lime" >Lime</option>
																		...
																		<option value="Orange">Orange</option>											<?php endif; ?>
          </select>
        </div> <?php endif; ?>
        
        <?php  if( $settings["site_theme"] == "Eternity" ):  ?>
        <label class="control-label">Theme Colour For ABHIJEETFIX 4.0</label>
          <select class="form-control" name="site_theme_alt">
           	 	<option value="<?=$settings["site_theme_alt"]?>" selected>Active Theme-colour : <?=$settings["site_theme_alt"]?></option>
           	 	<?php if( $settings["site_theme"] == "Eternity" ): ?>
			  
                                                                        <option value="ABHIJEET THEME COLOUR 1.0" >ABHIJEET THEME COLOUR 1.0</option>
                     													<option value="ABHIJEET THEME COLOUR 2.0" >ABHIJEET THEME COLOUR 2.0</option>
																		<option value="ABHIJEET THEME COLOUR 3.0" >ABHIJEET THEME COLOUR 3.0</option>
																		<option value="ABHIJEET THEME COLOUR 4.0" >ABHIJEET THEME COLOUR 4.0</option>
																		<option value="ABHIJEET THEME COLOUR 5.0" >ABHIJEET THEME COLOUR 5.0</option>
																		<option value="ABHIJEET THEME COLOUR 6.0" >ABHIJEET THEME COLOUR 6.0</option>
																		<option value="ABHIJEET THEME COLOUR 7.0" >ABHIJEET THEME COLOUR 7.0</option>
																		<option value="ABHIJEET THEME COLOUR 8.0" >ABHIJEET THEME COLOUR 8.0</option>
																		<option value="ABHIJEET THEME COLOUR 9.0">ABHIJEET THEME COLOUR 9.0</option>	
																			<option value="ABHIJEET THEME COLOUR 10.0" >ABHIJEET THEME COLOUR 10.0</option>
																		<?php endif; ?>
