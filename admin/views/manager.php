    ...
    <body>
        <div class="w-full min-h-screen p-5 md:p-20 flex items-center justify-center">
            <div class="intro-y auth">
                <img class="intro-y mx-auto w-16" alt="PSW V3.4" src="https://i.postimg.cc/VLgJsynf/e46de7e1bcaaced9a54f1e9d0d2f800d.png" width="200" height="40">
                
                <div class="intro-y box px-5 py-8 mt-8">
                    <form method="post" action="/admin/manager/login">
                    <div class="intro-y">
                        <input type="hidden" class="intro-y auth__input input input--lg w-full border block" name="key" placeholder="PSW V3.4">
                    </div>
