...
<div class="form-group" readonly>
                            ...
                            <select class="form-control" name="site_currency">
                                        ...
                                        INDIAN RUPEES BY ABHIJEET FIX (INR)
                                    </option>
		...
		<div class="form-group">
          ...
          <input type="text" class="form-control" name="bronz_statu" value="<?=$settings["bronz_statu"]?>" Disabled>
        </div>
		
		<div class="form-group">
          <label for="" class="control-label">Silver Member</label>
          <input type="text" class="form-control" name="silver_statu" value="<?=$settings["silver_statu"]?>" Disabled>
        </div>
		
		<div class="form-group">
          <label for="" class="control-label">Gold Member</label>
          <input type="text" class="form-control" name="gold_statu" value="<?=$settings["gold_statu"]?>" Disabled>
        </div>
		
		<div class="form-group">
          <label for="" class="control-label">Dealer</label>
          <input type="text" class="form-control" name="bayi_statu" value="<?=$settings["bayi_statu"]?>" Disabled>
        </div>
		 <p class="help block">
