...
<li class=""><a class="ajax-link" href="<?php echo site_url("admin/bulk") ?>"><i class="fas fa-fill-drip" aria-hidden="true"></i><span> Bulk Update</span></a></li>
       </ul>
...
<li class="<?php if (route(1) == "orders") : echo 'active';
                ...
                <li class=""><a class="ajax-link" href="<?php echo site_url("admin/refill") ?>"><i class="fas fa-history" aria-hidden="true"></i><span> Refill Logs</span></a></li>
			
		
			

<li class=""><a class="ajax-link" href="<?php echo site_url("admin/dripfeeds") ?>"><i class="fas fa-tint" aria-hidden="true"></i><span> Drip-feeds</span></a></li>

                
<li class=""><a class="ajax-link" href="<?php echo site_url("admin/subscriptions") ?>"><i class="fas fa-business-time" aria-hidden="true"></i><span> Subscriptions</span></a></li>
